    ...
    <div>
      ...
      <div className='container m-auto mt-5 table-responsive  table-responsive-sm table-responsive-md' >
        <table className='table table-hover '>
          <thead className=' fs-4' style={{ backgroundColor: "#4C230A" }}>
            <tr>
              <th scope='col' >#</th>
        ...
        <div>
          <button className='btn  mt-5 '  style={{ backgroundColor: "#E09F3E" ,color:"black"}} onClick={handleCheckOut} > Check Out </button>
        </div>
      </div>
